@extends('layouts.app')
@section('pageTitle', 'BSc in Civil Engineering (Top Up)')
@section('logo', 'logo')
@section('content')
            ...
            <div class="row">
                <div class="col-lg-8 pt-4 pt-lg-0 content text-justify" data-aos="fade-left">
                    <div class="section-title2">
                        <h6>BSc in Civil Engineering (Top Up)</h6>
                ...
                <div class="col-lg-4" data-aos="fade-right">
                    <div id="testimonials" class="testimonials">
                        <div class="testimonial-item">
                            <img src="/assets/img/programmes/civil-engin.jpg" class="img-fluid" style="border-radius: 10px; width: 100%; height: 300px" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container" data-aos="fade-up">
                <div class="row pt-lg-5">
                    <div class="entry">
                        ...
                        <p>Should possess Higher National Diploma in Civil Engineering at any UGC recognized institute or University
                    </div>
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                    <table class="rwd-table">
                                        ...
                                        <tr><td>Concrete Technology</td></tr>
                                        <tr><td>Irrigation Engineering </td></tr>
                                        <tr><td>Engineering Hydraulics</td></tr>
                                        <tr><td>Structural and Design</td></tr>
                                        <tr><td>Highway</td></tr>
