@extends('layouts.app')
@section('pageTitle', 'BSc in Physical Education & Sports ')
@section('logo', 'logo')
@section('content')
    <!-- ======= About Us Section ======= -->
            ...
            <div class="row">
                <div class="col-lg-8 pt-4 pt-lg-0 content text-justify" data-aos="fade-left">
                    <div class="section-title2">
                        <h6>BSc in Physical Education & Sports </h6>
                ...
                <div class="col-lg-4" data-aos="fade-right">
                    <div id="testimonials" class="testimonials">
                        <div class="testimonial-item">
                            <img src="/assets/img/programmes/bsc-physical-edu.jpg" class="img-fluid" style="border-radius: 10px; width: 100%; height: 300px" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container" data-aos="fade-up">
                <div class="row pt-lg-5">
                    <div class="entry">
                        ...
                        <p>Should possess two years of Diploma in Physical Education at any UGC recognized institute or University</p>
                    </div>
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                    <table class="rwd-table">
                                        ...
                                        <tr><td>Sociocultural Foundation of Physical Education</td></tr>
                                        <tr><td>Kinesiology & Biomechanics in Sporting Activity</td></tr>
                                        <tr><td>Information Technology</td></tr>
                                        <tr><td>Research Methods in Physical Education </td></tr>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
