@extends('layouts.app')
@section('pageTitle', 'Doctor of Education (D.Ed) or (Ph.D) ')
@section('logo', 'logo')
@section('content')
            ...
            <div class="row">
                <div class="col-lg-8 pt-4 pt-lg-0 content text-justify" data-aos="fade-left">
                    <div class="section-title2">
                        <h6>Doctor of Education (D.Ed) or (Ph.D)</h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 pt-lg-4 pt-sm-5 content bg-light" data-aos="fade-left">
                            <ul>
                                <li><i class="bx bx-time"></i>2 - 3 Years</li>
                ...
                <div class="col-lg-4" data-aos="fade-right">
                    <div id="testimonials" class="testimonials">
                        <div class="testimonial-item">
                            <img src="/assets/img/programmes/doctor-education.jpg" class="img-fluid" style="border-radius: 10px; width: 100%; height: 300px" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container" data-aos="fade-up">
                <div class="row pt-lg-5">
                    <div class="entry">
                        ...
                        <p>Should possess a degree in Master's in education or any master degree at any UGC recognized institute or University
                    </div>
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                    <table class="rwd-table">
                                        ...
                                        <tr><td>Advanced Research Methods for Education </td></tr>
                                        <tr><td>Paradigms and Professional Research in Education</td></tr>
                                        <tr><td>Applying Research Methods in Education</td></tr>
                                        <tr><td>Professional Workplace Culture and Learning</td></tr>
                                        <tr><td>Professional Practice in Education</td></tr>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
