@extends('layouts.app')
@section('pageTitle', 'BA in English (Top UP) ')
@section('logo', 'logo')
@section('content')
                ...
                <div class="col-lg-4" data-aos="fade-right">
                    <div id="testimonials" class="testimonials">
                        <div class="testimonial-item">
                            <img src="/assets/img/programmes/ba-english.jpg" class="img-fluid" style="border-radius: 10px; width: 100%; height: 300px" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container" data-aos="fade-up">
                <div class="row pt-lg-5">
                    <div class="entry">
                        ...
                        <p>Should possess two years of Diploma degree in the relevant program at any UGC recognized institute or University</p>
                    </div>
