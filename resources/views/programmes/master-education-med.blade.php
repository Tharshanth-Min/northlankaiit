@extends('layouts.app')
@section('pageTitle', 'Master of Education (M.Ed)')
@section('logo', 'logo')
@section('content')
                ...
                <div class="col-lg-4" data-aos="fade-right">
                    <div id="testimonials" class="testimonials">
                        <div class="testimonial-item">
                            <img src="/assets/img/programmes/master-education.jpg" class="img-fluid" style="border-radius: 10px; width: 100%; height: 300px" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container" data-aos="fade-up">
                <div class="row pt-lg-5">
                    <div class="entry">
                        ...
                        <p>Should possess a degree in Bachelor of Education or Postgraduate diploma in Edu at any UGC recognized institute or University
                        </p>
                    </div>
